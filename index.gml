...
<div style="float:right; width:20%; padding:12px">
  ...
  <gm:list id="Sources">
    ...
    <input type="checkbox" name="polygon" 
          onclick="kmlPE('http://webpages.cs.luc.edu/~cramirez/TestPolygon1.kml', 7)">Polygon</input> 
    <input type="checkbox" name="england" 
          onclick="kmlPE('http://www.geograph.org.uk/feed/recent.rss', 6)">England (from feed)</input>  
  </gm:list>
</div>
